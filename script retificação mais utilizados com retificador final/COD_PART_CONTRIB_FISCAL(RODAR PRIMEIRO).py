...
def extract_cnpj_to_participant_map(sped_contribuicoes_path, sped_fiscal):
    """Cria um mapa de CNPJ para o código do participante a partir dos arquivos sped_contribuicoes.txt e sped_fiscal.txt."""
    cnpj_to_participant = {}
...
def main():
    ...
    sped_contribuicoes = '2024_02_ATUALIZADO_script2.txt'
    sped_fiscal = 'sped_02_2024.txt'
    intermediate_output = 'sped_contribuicoes_intermediario.txt'
    final_output = '2024_02_ATUALIZADO_script3.txt'
    ...
    cnpj_to_participant = extract_cnpj_to_participant_map(intermediate_output, sped_fiscal)
